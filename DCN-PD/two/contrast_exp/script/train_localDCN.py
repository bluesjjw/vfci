...
def trainDCN(treated_dataset, control_dataset):
    ...
    torch.save(network.state_dict(), "../save/script/client{0}/singleDCN.pth".format(client))
...
if __name__ == "__main__":
    ...
    psn_model_path2 = "../save/script/client2/0PSNet_epoch50_lr0.001.pth"
    psn_model_path1 = "../save/script/client1/0PSNet_epoch50_lr0.001.pth"
    ...
    if client == 1:
        ...
        treated_ps = evalPSN(psn_model_path1, treated_x)
        control_ps = evalPSN(psn_model_path1, control_x)
    if client == 2:
        treated_x = treated_data2[1]
        control_x = control_data2[1]
        treated_ps = evalPSN(psn_model_path2, treated_x)
        control_ps = evalPSN(psn_model_path2, control_x)
