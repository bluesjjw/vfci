...
def train(args, phase, data_loader,network):
    ...
    model_save_path = "../save/4client_select/select_three/MergePSN_{0}_{1}_{2}.pth".format(client_1,client_2,client_3)
