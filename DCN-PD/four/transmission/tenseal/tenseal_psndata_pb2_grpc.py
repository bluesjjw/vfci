...
import transmission.tenseal.tenseal_psndata_pb2 as tenseal__psndata__pb2
...
class SafeTransmissionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MiddleForward = channel.unary_unary(
                ...
                request_serializer=tenseal__psndata__pb2.encrypted.SerializeToString,
                response_deserializer=tenseal__psndata__pb2.encrypted.FromString,
                )
        self.MiddleBackward = channel.unary_unary(
                '/SafeTransmission/MiddleBackward',
                request_serializer=tenseal__psndata__pb2.gradenc.SerializeToString,
                response_deserializer=tenseal__psndata__pb2.sendgradflag.FromString,
                )
        self.BottomBackward = channel.unary_unary(
                '/SafeTransmission/BottomBackward',
                request_serializer=tenseal__psndata__pb2.sendgrad.SerializeToString,
                response_deserializer=tenseal__psndata__pb2.encrypted.FromString,
                )
...
def add_SafeTransmissionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MiddleForward': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tenseal__psndata__pb2.encrypted.FromString,
                    response_serializer=tenseal__psndata__pb2.encrypted.SerializeToString,
            ),
            'MiddleBackward': grpc.unary_unary_rpc_method_handler(
                    servicer.MiddleBackward,
                    request_deserializer=tenseal__psndata__pb2.gradenc.FromString,
                    response_serializer=tenseal__psndata__pb2.sendgradflag.SerializeToString,
            ),
            'BottomBackward': grpc.unary_unary_rpc_method_handler(
                    servicer.BottomBackward,
                    request_deserializer=tenseal__psndata__pb2.sendgrad.FromString,
                    response_serializer=tenseal__psndata__pb2.encrypted.SerializeToString,
            ),
    }
...
class SafeTransmission(object):
    ...
    def MiddleForward(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/SafeTransmission/MiddleForward',
            tenseal__psndata__pb2.encrypted.SerializeToString,
            tenseal__psndata__pb2.encrypted.FromString,
    ...
    def MiddleBackward(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/SafeTransmission/MiddleBackward',
            tenseal__psndata__pb2.gradenc.SerializeToString,
            tenseal__psndata__pb2.sendgradflag.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def BottomBackward(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/SafeTransmission/BottomBackward',
            tenseal__psndata__pb2.sendgrad.SerializeToString,
            tenseal__psndata__pb2.encrypted.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
