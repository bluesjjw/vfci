...
class DataPartition:
    def __init__(self, csv_path, split_size, seed=3456,num_users=4):
    ...
    def getDCNTensorWithoutLabel(self, csv_path, phase, index_dict):
        ...
        treat_covariates_X = treat_df.iloc[:, 1:8].to_numpy()
        ...
        control_covariates_X = control_df.iloc[:, 1:8].to_numpy()
...
if __name__ == "__main__":
    ...
    print(dic["control_trainData"][0][8])
    print(dic1["control_trainData"][0][8])
    print(dic["control_trainData"][1][8])
    print(dic1["control_trainData"][1][8])
