...
from contrast_exp.contrast_exp_model.client_num4.Dragonnet import Dragonnet
...
def train_dragonNet(train_x, concat_true, loss_func):
    ...
    for epo in range(1, 201):
        ...
        if epo % 10 == 0:
            print(t)
    torch.save(dragonnet.state_dict(), '../save/client_num4/DragonNet_Central.pth')


if __name__ == "__main__":
    csv_path1 = '../../data/client_num4/client1.csv'
    csv_path2 = '../../data/client_num4/client2.csv'
    csv_path3 = '../../data/client_num4/client3.csv'
    csv_path4 = '../../data/client_num4/client4.csv'
    dp = DataPartition(csv_path1, 0.8, 2)
    datadict1 = dp.getDragonNetTensor(csv_path1, 0)
    datadict2 = dp.getDragonNetTensor(csv_path2, 1)
    datadict3 = dp.getDragonNetTensor(csv_path3, 3)
    datadict4 = dp.getDragonNetTensor(csv_path4, 4)
    dragonNet_train_x_1 = datadict1["DragonNet_trainData"][1]
    dragonNet_train_x_2 = datadict2["DragonNet_trainData"][1]
    dragonNet_train_x_3 = datadict3["DragonNet_trainData"][1]
    dragonNet_train_x_4 = datadict4["DragonNet_trainData"][1]
    train_x = torch.cat((dragonNet_train_x_1, dragonNet_train_x_2, dragonNet_train_x_3, dragonNet_train_x_4), dim=1)
    # print(train_x.shape)
