...
if __name__ == "__main__":
    ...
    for i in range(0, 100):
        ...
        datadict3 = dp.getDragonNetTensor(csv_path3, 0)
        datadict4 = dp.getDragonNetTensor(csv_path4, 0)
        dragonNet_test_x_1 = datadict1["DragonNet_testData"][1]
        dragonNet_test_x_2 = datadict2["DragonNet_testData"][1]
        dragonNet_test_x_3 = datadict3["DragonNet_testData"][1]
        dragonNet_test_x_4 = datadict4["DragonNet_testData"][1]
        test_x = torch.cat((dragonNet_test_x_1, dragonNet_test_x_2, dragonNet_test_x_3, dragonNet_test_x_4), dim=1)
        # print(test_x.shape)
        ...
        dragonNet.load_state_dict(
            torch.load('../save/client_num4/DragonNet_Central.pth'))
        dragonNet.eval()
